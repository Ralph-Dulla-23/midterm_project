      ...
      body: Center(
          child: Column(
            ...
            ElevatedButton(
              ...
              child: Text('Go to Screen 2', style: TextStyle(fontSize: 20)),
              onPressed: () {
                Navigator.push(
                  context,
            ...
            ElevatedButton(
              ...
              child: Text('Go to Screen 3', style: TextStyle(fontSize: 20)),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ThirdScreen()),
            ...
            ElevatedButton(
              ...
              child: Text('Go to Screen 4', style: TextStyle(fontSize: 20)),
              onPressed: () {
                Navigator.push(
                  context,
            ...
            ElevatedButton(
              ...
              child: Text('Go to Screen 5', style: TextStyle(fontSize: 20)),
              onPressed: () {
                Navigator.push(
                  context,
